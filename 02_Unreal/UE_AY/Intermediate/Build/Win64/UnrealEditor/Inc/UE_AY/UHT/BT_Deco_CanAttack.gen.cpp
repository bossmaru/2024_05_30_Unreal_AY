...
#include "UE_AY/BT_Deco_CanAttack.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBT_Deco_CanAttack() {}

// Begin Cross Module References
AIMODULE_API UClass* Z_Construct_UClass_UBTDecorator();
UE_AY_API UClass* Z_Construct_UClass_UBT_Deco_CanAttack();
UE_AY_API UClass* Z_Construct_UClass_UBT_Deco_CanAttack_NoRegister();
...
template<> UE_AY_API UClass* StaticClass<UBT_Deco_CanAttack>()
{
	return UBT_Deco_CanAttack::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Deco_CanAttack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBT_Deco_CanAttack, UBT_Deco_CanAttack::StaticClass, TEXT("UBT_Deco_CanAttack"), &Z_Registration_Info_UClass_UBT_Deco_CanAttack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBT_Deco_CanAttack), 880743922U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Deco_CanAttack_h_3492126487(TEXT("/Script/UE_AY"),
	Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Deco_CanAttack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Deco_CanAttack_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
