...
#include "UE_AY/BT_Task_Attack.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBT_Task_Attack() {}

// Begin Cross Module References
AIMODULE_API UClass* Z_Construct_UClass_UBTTaskNode();
UE_AY_API UClass* Z_Construct_UClass_UBT_Task_Attack();
UE_AY_API UClass* Z_Construct_UClass_UBT_Task_Attack_NoRegister();
...
template<> UE_AY_API UClass* StaticClass<UBT_Task_Attack>()
{
	return UBT_Task_Attack::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_Attack_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBT_Task_Attack, UBT_Task_Attack::StaticClass, TEXT("UBT_Task_Attack"), &Z_Registration_Info_UClass_UBT_Task_Attack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBT_Task_Attack), 3856850653U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_Attack_h_2861863212(TEXT("/Script/UE_AY"),
	Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_Attack_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_Attack_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
