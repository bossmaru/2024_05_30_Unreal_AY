...
#include "UE_AY/BT_Task_FindRandomPos.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeBT_Task_FindRandomPos() {}

// Begin Cross Module References
AIMODULE_API UClass* Z_Construct_UClass_UBTTaskNode();
UE_AY_API UClass* Z_Construct_UClass_UBT_Task_FindRandomPos();
UE_AY_API UClass* Z_Construct_UClass_UBT_Task_FindRandomPos_NoRegister();
...
template<> UE_AY_API UClass* StaticClass<UBT_Task_FindRandomPos>()
{
	return UBT_Task_FindRandomPos::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_FindRandomPos_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBT_Task_FindRandomPos, UBT_Task_FindRandomPos::StaticClass, TEXT("UBT_Task_FindRandomPos"), &Z_Registration_Info_UClass_UBT_Task_FindRandomPos, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBT_Task_FindRandomPos), 3704163346U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_FindRandomPos_h_3113235932(TEXT("/Script/UE_AY"),
	Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_FindRandomPos_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE_AY_Source_UE_AY_BT_Task_FindRandomPos_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
